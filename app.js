// //selectors 
// const todoBoutton =document.querySelector('.todo-button')
// const todoInput =document.querySelector('.todo-input')

//  var tasks =[];
// todoBoutton.addEventListener('click', function add(e){
//     e.preventDefault();
//      for(i=0;i<tasks.length;i++){
//        tasks[i].push (todoInput.value)

//     // //    var taskvalue = document.querySelector('.todo-input').value;
